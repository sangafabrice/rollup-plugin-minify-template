...
function globifyExtensions(extensions: OptionExtension): string {
 ...
 */
export default function minifyTemplate(options: { extensions: OptionExtension } = { extensions: defaultExtensions }): Plugin {
